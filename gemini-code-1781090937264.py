...
# 3. 50대 데이터셋 유연성 인프라 (대표 10종 탑재, 50개까지 데이터 확장 가능하도록 설계)
@st.cache_data
def load_all_foods():
    return [
        ...
        {"id": "salmon", "emoji": "🐟", "name_ko": "연어", "name_en": "Salmon", "name_zh": "三文鱼", "tag_ko": "오메가-3의 대명사", "tag_en": "Omega-3 Rich Fish", "tag_zh": "富含欧米伽-3", "badge_ko": "고단백질", "badge_en": "High Protein", "badge_zh": "高蛋白质", "desc_ko": "연어는 혈관 건강을 지켜주는 오메가-3 지방산이 매우 풍부합니다.", "desc_en": "Excellent source of premium omega-3 fatty acids.", "desc_zh": "富含深海不饱和脂肪酸，对大脑和心血管极佳。", "cal": 208, "pro": 20.0, "car": 0.0, "fat": 13.0, "fib": 0.0, "iron": 0.3, "video_url": "https://www.youtube.com/results?search_query=salmon+recipe"},
        {"id": "spinach", "emoji": "🥬", "name_ko": "시금치", "name_en": "Spinach", "name_zh": "菠菜", "tag_ko": "뽀빠이 철분 채소", "tag_en": "Iron-Rich Green", "tag_zh": "富含铁质绿叶菜", "badge_ko": "엽산 풍부", "badge_en": "Folic Acid", "badge_zh": "富含叶酸", "desc_ko": "시금치는 유기산과 철분, 비타민이 고루 배합된 녹색 채소의 왕입니다.", "desc_en": "Dense in vitamin K, iron, and green antioxidants.", "desc_zh": "大力水手最爱的绿叶矿物质与铁质之王。", "cal": 23, "pro": 2.9, "car": 3.6, "fat": 0.4, "fib": 2.2, "iron": 2.7, "video_url": "https://www.youtube.com/results?search_query=spinach+recipe"},
        {"id": "garlic", "emoji": "🧄", "name_ko": "마늘", "name_en": "Garlic", "name_zh": "大蒜", "tag_ko": "천연 면역 강화제", "tag_en": "Natural Immunity", "tag_zh": "天然免疫增强剂", "badge_ko": "알리신 함유", "badge_en": "Allicin Power", "badge_zh": "富含蒜素", "desc_ko": "알리신 성분이 강력한 항균 작용과 신진대사를 촉진합니다.", "desc_en": "Contains allicin, known for robust defense attributes.", "desc_zh": "大蒜素具有极强的抗菌和提高免疫力的功效。", "cal": 149, "pro": 6.4, "car": 33.1, "fat": 0.5, "fib": 2.1, "iron": 1.7, "video_url": "https://www.youtube.com/results?search_query=garlic+recipe"},
        {"id": "walnut", "emoji": "🥜", "name_ko": "호두", "name_en": "Walnut", "name_zh": "核桃", "tag_ko": "두뇌 활성화 견과", "tag_en": "Brain Superfood", "tag_zh": "健脑益智坚果", "badge_ko": "불포화지방", "badge_en": "Healthy Lipids", "badge_zh": "优质脂肪", "desc_ko": "뇌 세포를 보호하고 인지 능력을 개선하는 견과류입니다.", "desc_en": "Resembles the brain and brilliantly nourishes it.", "desc_zh": "外形神似大脑，富含抗氧化物质与亚麻酸。", "cal": 654, "pro": 15.2, "car": 13.7, "fat": 65.2, "fib": 6.7, "iron": 2.9, "video_url": "https://www.youtube.com/results?search_query=walnut+recipe"},
        {"id": "mushroom", "emoji": "🍄", "name_ko": "표고버섯", "name_en": "Shiitake", "name_zh": "香菇", "tag_ko": "면역 베타글루칸", "tag_en": "Beta-Glucan Core", "tag_zh": "富含β-葡聚糖", "badge_ko": "비타민D", "badge_en": "Vitamin D", "badge_zh": "富含维D", "desc_ko": "베타글루칸 성분이 가득하여 항암 및 면역 조절에 탁월합니다.", "desc_en": "Rich umami texture boosting cellular shields.", "desc_zh": "独特的鲜味成分，具有极高的免疫调节机能。", "cal": 34, "pro": 2.2, "car": 6.8, "fat": 0.5, "fib": 2.5, "iron": 0.4, "video_url": "https://www.youtube.com/results?search_query=shiitake+recipe"}
    ]

# 4. 언제나 완벽하게 5개 시리즈를 동적 생성해내는 레시피 엔진
...
# 50대 식재료 상호 연동을 위한 상단 글로벌 드롭다운 셀렉터 배치
default_idx = 0
...
with tab2:
    ...
    # 동적 매핑 엔진에서 고유 5대 레시피 시리즈 수집 (정확하게 5개 루프)
        ...
        with col_btn1:
            if rc['title'] in st.session_state.my_fridge:
                ...
                if st.button(text_pack['btn_add'], key=f"t2_add_{idx}_{active_food['id']}", use_container_width=True):
                    ...
                    st.rerun()
        with col_btn2:
            # 🚨 [영상 가이드 버튼 완벽 복원] 클릭 시 해당 재료의 요리 가이드 유튜브 검색 결과로 연결
